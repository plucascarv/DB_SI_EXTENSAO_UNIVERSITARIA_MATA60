-- =============================================
-- QUERY 1: Relatório de Impacto e Participação
-- =============================================
SELECT 
    a.ID_ATIVIDADE,
    a.NM_ATIVIDADE,
...
-- =============================================
-- QUERY 2: Gestão de Múltiplos Instrutores
-- =============================================
SELECT 
    a.ID_ATIVIDADE,
    a.NM_ATIVIDADE,
    ...
    GROUP_CONCAT(DISTINCT p.NM_PRIMEIRO || ' ' || COALESCE(p.NM_MEIO, '') || ' ' || p.NM_ULTIMO) as nomes_instrutores,
...
-- =============================================
-- QUERY 3: Análise de Parcerias
-- =============================================
SELECT 
    par.TP_CATEGORIA,
    par.NM_EMPRESA,
    COUNT(DISTINCT par.ID_ATIVIDADE) as total_atividades_apoiadas,
    GROUP_CONCAT(DISTINCT a.NM_ATIVIDADE) as atividades_apoiadas,
...
-- =============================================
-- QUERY 4: Emissão de Certificados
-- =============================================
SELECT 
    p.ID_PARTICIPANTE,
    ...
    (SELECT COUNT(*) 
     ...
     AND date(a2.DT_ATIVIDADE) <= date('now')
...
WITH status_atividade AS (
    SELECT 
        ...
        a.NM_AREA_ESTUDO,
        CASE 
            WHEN date(a.DT_ATIVIDADE) > date('now') THEN 'AGENDADA'
            WHEN date(a.DT_ATIVIDADE) = date('now') THEN 'EM ANDAMENTO'
            ELSE 'REALIZADA'
...
HAVING COUNT(rl.ID_PARTICIPANTE) >= 3
ORDER BY taxa_resposta DESC, total_participantes DESC;

-- =============================================
-- QUERY 7: Participação por Instituição
-- =============================================
SELECT 
    p.NM_INSTITUICAO,
    a.NM_AREA_ESTUDO,
...
HAVING total_participantes_unicos >= 2
ORDER BY p.NM_INSTITUICAO, total_atividades_participadas DESC;

-- =============================================
-- QUERY 8: Gestão de Cronograma
-- =============================================
SELECT 
    a.ID_ATIVIDADE,
    a.NM_ATIVIDADE,
...
-- =============================================
-- QUERY 9: Eficiência de Parcerias
-- =============================================
SELECT 
    par.TP_CATEGORIA,
    CASE 
...
-- =============================================
-- QUERY 10: Relatório Consolidado
-- =============================================
...
-- =============================================
-- FIM DAS 10 QUERIES AVANÇADAS
-- =============================================
SELECT '🎉 TODAS AS 10 QUERIES EXECUTADAS COM SUCESSO!' as resultado_final;